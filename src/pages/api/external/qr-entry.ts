...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    console.log('🔍 [External QR Scanner] Looking for visitor:', { visitorId });
    ...
    console.log('👤 [External QR Scanner] Visitor found:', visitor ? {
      id: visitor._id,
    ...
    if (visitor.status === 'Visited') {
      console.log('⚠️ [External QR Scanner] Visitor already visited');
    ...
    console.log('✅ [External QR Scanner] Successfully processed QR entry');
